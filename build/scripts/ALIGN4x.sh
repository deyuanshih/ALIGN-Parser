...
LAYOUT_FILE_PATH="${DATASETPATH}/Dataset/layout_design/ALIGN4x/"
SCHEMATIC_FILE_PATH="${DATASETPATH}/Dataset/schematic_design/ALIGN4x/"
GRAPH_FILE_PATH="${DATASETPATH}/Dataset/graph_design/ALIGN4x/"
GRAPH_NAME=""
