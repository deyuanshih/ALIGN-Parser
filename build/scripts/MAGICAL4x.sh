...
LAYOUT_FILE_PATH="${DATASETPATH}/Dataset/layout_design/MAGICAL4x/"
SCHEMATIC_FILE_PATH="${DATASETPATH}/Dataset/schematic_design/MAGICAL4x/"
GRAPH_FILE_PATH="${DATASETPATH}/Dataset/graph_design/MAGICAL4x/"
GRAPH_NAME=""
