...
LAYOUT_FILE_PATH="${DATASETPATH}/Dataset/layout_design/MAGICAL16x/"
SCHEMATIC_FILE_PATH="${DATASETPATH}/Dataset/schematic_design/MAGICAL16x/"
GRAPH_FILE_PATH="${DATASETPATH}/Dataset/graph_design/MAGICAL16x/"
GRAPH_NAME=""
...
filename="${DATASETPATH}/Dataset/schematic_design_list_MAGICAL.txt"
n=0
i=57
