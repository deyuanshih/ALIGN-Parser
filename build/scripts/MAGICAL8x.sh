...
LAYOUT_FILE_PATH="${DATASETPATH}/Dataset/layout_design/MAGICAL8x/"
SCHEMATIC_FILE_PATH="${DATASETPATH}/Dataset/schematic_design/MAGICAL8x/"
GRAPH_FILE_PATH="${DATASETPATH}/Dataset/graph_design/MAGICAL8x/"
GRAPH_NAME=""
