...
LAYOUT_FILE_PATH="${DATASETPATH}/Dataset/layout_design/ALIGN2x/"
SCHEMATIC_FILE_PATH="${DATASETPATH}/Dataset/schematic_design/ALIGN2x/"
GRAPH_FILE_PATH="${DATASETPATH}/Dataset/graph_design/ALIGN2x/"
GRAPH_NAME=""
