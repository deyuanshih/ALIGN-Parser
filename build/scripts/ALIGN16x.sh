...
LAYOUT_FILE_PATH="${DATASETPATH}/Dataset/layout_design/ALIGN16x/"
SCHEMATIC_FILE_PATH="${DATASETPATH}/Dataset/schematic_design/ALIGN16x/"
GRAPH_FILE_PATH="${DATASETPATH}/Dataset/graph_design/ALIGN16x/"
GRAPH_NAME=""
