...
LAYOUT_FILE_PATH="${DATASETPATH}/Dataset/layout_design/MAGICAL2x/"
SCHEMATIC_FILE_PATH="${DATASETPATH}/Dataset/schematic_design/MAGICAL2x/"
GRAPH_FILE_PATH="${DATASETPATH}/Dataset/graph_design/MAGICAL2x/"
GRAPH_NAME=""
