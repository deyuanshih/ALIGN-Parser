...
LAYOUT_FILE_PATH="${DATASETPATH}/Dataset/layout_design/ALIGN/"
SCHEMATIC_FILE_PATH="${DATASETPATH}/Dataset/schematic_design/ALIGN/"
GRAPH_FILE_PATH="${DATASETPATH}/Dataset/graph_design/ALIGN/"
GRAPH_NAME=""
