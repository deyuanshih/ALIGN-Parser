...
LAYOUT_FILE_PATH="${DATASETPATH}/Dataset/layout_design/MAGICAL/"
SCHEMATIC_FILE_PATH="${DATASETPATH}/Dataset/schematic_design/MAGICAL/"
GRAPH_FILE_PATH="${DATASETPATH}/Dataset/graph_design/MAGICAL/"
GRAPH_NAME=""
